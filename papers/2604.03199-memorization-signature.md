...
## Key Contributions
- メンバーシップ推定を学習可能化したLT-MIAを提案（手作り指標から脱却）
- Transformerで学習した“記憶シグネチャ”がMamba/RWKV/RecurrentGemmaへ転移可能
- 0.1%FPRでTPRを2.8×向上、コードと分類器を公開

## Links
- Paper: https://arxiv.org/abs/2604.03199v1
- Code: https://github.com/JetBrains-Research/learned-mia
